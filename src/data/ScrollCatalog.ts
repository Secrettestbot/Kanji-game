...
const scrolls: ScrollData[] = [
  {
    ...
    mapData: {
      ...
      belts: [],
      oreNodes: [
        { radical: '日', x: 3, y: 3, richness: 3 },
        { radical: '山', x: 3, y: 8, richness: 3 },
        { radical: '一', x: 9, y: 3, richness: 3 },
        { radical: '人', x: 9, y: 8, richness: 3 },
        { radical: '大', x: 15, y: 3, richness: 3 },
        { radical: '木', x: 15, y: 8, richness: 3 },
      ],
  ...
  },
  {
    ...
    mapData: {
      ...
      belts: [],
      oreNodes: [
        { radical: '川', x: 3, y: 3, richness: 3 },
        { radical: '水', x: 3, y: 8, richness: 3 },
        { radical: '小', x: 9, y: 3, richness: 3 },
        { radical: '月', x: 9, y: 8, richness: 3 },
        { radical: '日', x: 15, y: 3, richness: 2 },
        { radical: '山', x: 15, y: 8, richness: 2 },
        { radical: '人', x: 21, y: 3, richness: 2 },
      ],
      orderQueue: ['川', '水', '小', '月'],
      dispatchQuotas: [],
    },
  },
  {
    ...
    mapData: {
      ...
      belts: [],
      oreNodes: [
        { radical: '火', x: 3, y: 3, richness: 3 },
        { radical: '金', x: 3, y: 8, richness: 3 },
        { radical: '土', x: 9, y: 3, richness: 3 },
        { radical: '口', x: 9, y: 8, richness: 3 },
        { radical: '日', x: 15, y: 3, richness: 2 },
        { radical: '大', x: 15, y: 8, richness: 2 },
        { radical: '木', x: 21, y: 3, richness: 2 },
        { radical: '水', x: 21, y: 8, richness: 2 },
      ],
      orderQueue: ['火', '金', '土', '口'],
      dispatchQuotas: [],
    },
  },
  {
    ...
    mapData: {
      ...
      belts: [],
      oreNodes: [
        { radical: '一', x: 3, y: 3, richness: 3 },
        { radical: '大', x: 3, y: 8, richness: 3 },
        { radical: '田', x: 3, y: 13, richness: 3 },
        { radical: '力', x: 9, y: 3, richness: 3 },
        { radical: '女', x: 9, y: 8, richness: 3 },
        { radical: '子', x: 9, y: 13, richness: 3 },
        { radical: '目', x: 15, y: 3, richness: 3 },
        { radical: '人', x: 15, y: 8, richness: 2 },
        { radical: '口', x: 15, y: 13, richness: 2 },
        { radical: '火', x: 21, y: 3, richness: 2 },
        { radical: '山', x: 21, y: 8, richness: 2 },
      ],
  ...
  },
  {
    ...
    mapData: {
      ...
      belts: [],
      oreNodes: [
        { radical: '二', x: 3, y: 3, richness: 3 },
        { radical: '一', x: 3, y: 8, richness: 3 },
        { radical: '囗', x: 3, y: 13, richness: 3 },
        { radical: '八', x: 9, y: 3, richness: 3 },
        { radical: '手', x: 9, y: 8, richness: 3 },
        { radical: '禾', x: 9, y: 13, richness: 3 },
        { radical: '人', x: 15, y: 3, richness: 3 },
        { radical: '大', x: 15, y: 8, richness: 2 },
        { radical: '木', x: 15, y: 13, richness: 2 },
        { radical: '山', x: 21, y: 3, richness: 2 },
        { radical: '土', x: 21, y: 8, richness: 2 },
      ],
  ...
  },
  {
    ...
    mapData: {
      ...
      belts: [],
      oreNodes: [
        { radical: '門', x: 3, y: 3, richness: 3 },
        { radical: '口', x: 3, y: 8, richness: 3 },
        { radical: '丨', x: 3, y: 13, richness: 3 },
        { radical: '子', x: 9, y: 3, richness: 3 },
        { radical: '冖', x: 9, y: 8, richness: 3 },
        { radical: '土', x: 9, y: 13, richness: 3 },
        { radical: '儿', x: 15, y: 3, richness: 3 },
        { radical: '木', x: 15, y: 8, richness: 3 },
        { radical: '一', x: 15, y: 13, richness: 3 },
        { radical: '耳', x: 21, y: 3, richness: 3 },
        { radical: '大', x: 21, y: 8, richness: 2 },
        { radical: '人', x: 21, y: 13, richness: 2 },
        { radical: '日', x: 27, y: 3, richness: 2 },
        { radical: '目', x: 27, y: 8, richness: 2 },
      ],
